...
class NanoBananaClient:
    ...
    PROMPT_TEMPLATES = {
        ...
        JobMode.LIFESTYLE_SCENE: (
            ...
            "in a clean, elegant setting that complements its design and purpose. "
            "Prefer subtle contextual hints (like a tidy desk, smooth wooden surface, or neutral studio environment) "
            "over busy real-world backgrounds. Avoid clutter, unnecessary props, or objects behind the subject. "
            "The composition should feel intentional and professionally staged, with balanced lighting and shallow depth of field. "
            "The product type is not specified — first analyze and infer what kind of product it is "
            "(for example: sunglasses, jewelry, hat, shoes, watch, handbag, multitool, etc.) and follow the presentation style "
            "seen in high-end commercial or editorial product photography for that category. "
            "Do not modify, replace, or remove any part of the product. Preserve its original proportions, color, and texture. "
            "Do not add or attach objects to the product. "
            "The product should be the unmistakable focal point — crisp, well-lit, and harmoniously integrated "
            "into a minimalist, tasteful scene. "
            "Use soft, directional lighting, realistic reflections, and coherent shadows to create depth. "
            "Produce a photorealistic, premium-quality image suitable for ecommerce or advertising. "
            "minimalist background, elegant composition, shallow depth of field, soft natural light, unaltered product geometry, "
            "preserve logos and materials, commercial editorial photography style"
        )
    }
